...
# data general page
general_melt_df = pd.read_csv('dev/apps/dashboard/general_metrics_melt.csv')
...
# data performace
performace_df = pd.read_csv('dev/apps/dashboard/general_performaces.csv')
...
performace_melt_df =  pd.read_csv('dev/apps/dashboard/general_performace_melt.csv')

# data model  - model len
data = pd.read_csv('dev/apps/dashboard/final_df_compare_melt.csv')
...
def update_graph_model_metric_only(len_images,model,metric, metric_unet, n_clicks):
    ...
    if n_clicks == 0:
        ...
        graph_sunburst_model_len = px.sunburst(
                                                        data_to_sungraph,
                                                        names='Model',
                                                        parents='model_len',
                                                        values='model_len',
